document.addEventListener('DOMContentLoaded', function() {
  ...
  function fetchAndDisplayImages() {
    ...
    .then(data => {
      ...
      data.forEach(item => {
        const imageUrl = item.filePath; // Assuming the filePath is the URL or path to the image
        const imageElement = document.createElement('img');
        imageElement.src = imageUrl;
        imageElement.alt = item.caption || 'Uploaded Image'; // Use caption if available
